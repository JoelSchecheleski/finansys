...
export abstract class BaseRosourceFormComponent<T extends BaseResourceModel> implements OnInit, AfterContentChecked {
  ...
  protected abstract buidResourceForm(): void ;
